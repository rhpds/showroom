...
|string
|`ocp-terminal`
|Terminal type: `ocp-terminal` (ttyd sandbox with oc CLI), `wetty` (SSH via wetty), `both` (deploy both), `showroom` (deprecated alias for `ocp-terminal`), or `""` (no terminal).
...
|string
|`https://github.com/rhpds/nookbag/releases/download/nookbag-v0.4.0/nookbag-v0.4.0.zip`
